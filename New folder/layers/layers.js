...
lyr_googlemap_0.setVisible(true);lyr_male_cleaned_1.setVisible(true);lyr_female_cleaned_2.setVisible(true);
var layersList = [lyr_googlemap_0,lyr_male_cleaned_1,lyr_female_cleaned_2];
